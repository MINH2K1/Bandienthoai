...
if(isset($_GET['id']))
{
    $id_get = $_GET['id']; 
									...
									$sql_product = "Select * from products,hieu,loai where product_brand=hieu_id and product_cat=loai_id and products.status=0 and hieu_id= ' $id_get' and number>0";
									$result = $db->prepare($sql_product);
									$result->execute();	
									$products_rowdata = $result->fetchAll();
									foreach($products_rowdata as $data){
				...
				<div  style="width:25%;float:left;">
					 ...
					 <a style="font-size:10pt;color:black;" href=<?php echo $level."page/single.php"?>><?php echo $data['product_title'];?></a>
