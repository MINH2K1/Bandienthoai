...
<html>
	<head>
		...
		<script src="<?php echo $level.js_path."jquery.min.js";?>"></script>
		<script src="<?php echo $level.js_path."jqzoom.pack.1.0.1.js";?>" type="text/javascript"></script>
		<link rel="stylesheet" href="<?php echo $level.css_path."flexslider.css";?>" type="text/css" media="screen" />
		<script type="text/javascript" src="<?php echo $level.js_path."jquery.livequery.js";?>"></script>
		<link href="<?php echo $level.css_path."style1.css";?>" rel="stylesheet"  />
		<script src="<?php echo $level.js_path."imagezoom.js";?>"></script>
		<!-- FlexSlider -->
					<script defer src="<?php echo $level.js_path."jquery.flexslider.js";?>" ></script>
					<link rel="stylesheet" href="<?php echo $level.css_path."responsiveslides.css";?>"  >
	         
		            <script src="<?php echo $level.js_path."responsiveslides.min.js";?>"></script>
		<script>
